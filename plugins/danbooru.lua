...
return {
  ...
  usage = {
    "!danbooru - gets a random fresh image from Danbooru 馃敒",
    "!danboorud - random daily popular image 馃敒",
    "!danbooruw - random weekly popular image 馃敒",
    "!danboorum - random monthly popular image 馃敒"
  },
  patterns = {
    "^!danbooru$",
    "^!danbooru ?(d)$",
